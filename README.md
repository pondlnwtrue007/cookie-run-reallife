...
> 🛡️ **กันปุ่มรั่ว:** โหมดเล่นจริงจะ **ส่งปุ่มเฉพาะตอนหน้าต่าง MuMu อยู่หน้าสุด** เท่านั้น — สลับไปอัด OBS / เปิดเว็บได้ ปุ่มจะไม่เด้งไปสั่งโปรแกรมอื่น (ตั้งชื่อหน้าต่างได้ที่ช่อง "ส่งปุ่มเฉพาะหน้าต่าง" ในแอป · ว่าง = ส่งตลอด)
