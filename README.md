...
> เลือกกล้อง → ตั้งท่ายืน → กดปุ่มเขียว **"เล่นจริง"** → กระโดด/ย่อหน้ากล้อง! · มี **แถบไกด์สีฟ้า** บอกทุกขั้น + **ตัวนับ 🦘/🛝/🕊️** ให้เห็นว่าจับท่าได้จริง

---

## 🆕 อัปเดตล่าสุด — v1.1
- 🕊️ **ท่าบิน (Bonus Time)** — กางแขน (T) + กระพือปีก + เด้งตัวต่อเนื่อง = บินขึ้น · หยุด = ร่วง
- 🛡️ **กันปุ่มรั่ว** — ส่งปุ่มเฉพาะตอนหน้าต่าง MuMu อยู่หน้าสุด (เลือกจาก dropdown ในแอป) → เปิด OBS อัดคลิป/สลับเว็บได้ ไม่รั่ว
- ▶️ เปิดมาเป็นโหมดทดสอบเสมอ · 🔤 ฟอนต์ไทยสวยขึ้น (ไม่อ้วน) · 🐛 แก้บั๊กเปิด exe ไม่ได้

> ดูทุกเวอร์ชันที่หน้า [Releases](../../releases)
...
แอปจะ **จำค่าที่ตั้งไว้** (กล้อง/ปุ่ม/เส้น) ให้อัตโนมัติ · เปิดมาเป็น **โหมดทดสอบ** เสมอ (ต้องกดเล่นจริงเอง) · ต้องเปิดแบบ **Run as administrator** (`.exe`/`.bat` ขอให้เอง) ปุ่มถึงเข้าเกม

> 🛡️ **กันปุ่มรั่ว:** โหมดเล่นจริงจะ **ส่งปุ่มเฉพาะตอนหน้าต่าง MuMu อยู่หน้าสุด** เท่านั้น — สลับไปอัด OBS / เปิดเว็บได้ ปุ่มจะไม่เด้งไปสั่งโปรแกรมอื่น (เลือกหน้าต่างจาก **dropdown "ส่งปุ่มเข้าหน้าต่าง"** ในแอป กด ↻ รีเฟรชได้ · เลือก "ทุกหน้าต่าง" = ส่งตลอด)
